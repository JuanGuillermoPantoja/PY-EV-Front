      ...
      <>
        ...
        {isModalOpen && (
          <div className="fixed top-0 left-0 w-full h-full flex items-center justify-center bg-black bg-opacity-50">
            ...
            <h1 className="text-2xl my-4">Charla con el Bot y preguntale tus dudas sobre EventsBrews</h1>
              <div className="flex justify-center flex-col w-full ml-[30%]">
                {history.map((item, index) => (
                    <div className="bg-[#5c3b1f] h-10 m-2 max-w-md" key={index}>
              ...
              <div className="flex justify-center h-11">
                <input
                  type="text"
                  className="w-full bg-[#FFEEB3] rounded-sm text-[#AC703E] placeholder:text-[#AC703E] p-4 font-bold h-11"
