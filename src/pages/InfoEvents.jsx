	...
	const handleCommentSubmit = async () => {
		...
		try {
			if (editingComment) {
				...
				if (isClientAuthenticated) {
					await createComment(event.id, comment, client.client.id);
				...
				<div className='w-full h-full'>
					{filteredEvent ? (
						<div className='flex w-full h-full justify-between '>
							<div
								className='w-2/5 bg-black h-full bg-cover bg-center'
								style={{
										...
										<div className='w-full h-[50%] flex justify-around items-center'>
											...
											<div className='w-3/4 flex justify-around'>
												<button
													...
													className='w-1/3 bg-amber-500 text-amber-950 font-bold p-2 rounded-lg hover:bg-amber-600 duration-300'
												>
