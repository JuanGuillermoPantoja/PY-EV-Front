                  ...
                  <Slider className="w-full h-1/1" {...settings}>
                    {images?.images?.map((image, index) => (
                      <div className="w-full h-1/2" key={index}>
                        <img
                          className="w-full h-[450px] border-black border-4 rounded-xl"
                  ...
                  <div>
                    ...
                    <div className="w-full h-[50%] flex justify-around items-center">
                      <div className="w-1/4 h-full flex justify-start items-center">
                        <button className="flex flex-col justify-center items-center text-center" onClick={() => handleLike(event)}>
                          <div className="flex flex-col items-center justify-center text-center">
                            <AiFillLike color="#ff9800" size={25} />
                            <span className="ml-2">{likesCount}</span>
                          </div>
                        </button>
                        <button className="flex flex-col justify-center items-center text-center" onClick={() => handleDisLike(event)}>
                          <div className="flex flex-col items-center justify-center text-center">
