...
function EventsPage() {
	...
	return (
		<>
			<Navbar />
			<SimpleBar className="bg-[url('https://i.ibb.co/LQf91TG/fondo-EB.webp')] bg-fixed bg-cover bg-center flex flex-col h-[800px]">
				<div className='h-[650px] pb-4 bg-cover bg-center flex flex-col justify-center items-center'>
					<h1 className='bg-cover w-full bg-center text-4xl text-center '>
						Eventos
					</h1>
                ...
                sm:h-auto'
                  ...
                  sm:text-sm'
										...
										<p
											className='text-center h-[30%] text-sm'
										>
											{event.description}
										</p>
