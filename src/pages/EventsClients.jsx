                  ...
                  <div className="flex-col w-full h-full">
                    ...
                    >
                      ...
                      >
                        ...
                        <p className="h-[20%] bg-acent text-textBlack text-base xl:text-xl w-[75%] flex justify-center items-center relative z-10">
                          empanadas 2x1
                        </p>
                        <p className="h-10% bg-textBlack text-acent text-base xl:text-xl w-[75%] relative z-10">
                          {dayjs(event.dates)
                            .utc()
                      ...
                      <div className="w-full h-[50%] bg-cover bg-center flex flex-col justify-start items-center relative z-10">
                        <p className="bg-primary w-[75%] text-base xl:text-xl h-[40%] text-white">
                          {event.address}
                        </p>
                        <button className="bg-acent rounded-md text-base xl:text-xl my-2 p-2 text-black hover:bg-gold"
                          onClick={() => {
