		...
		<>
			<div className='flex flex-col items-center justify-center h-screen bg-gray-100'>
				<div className='flex justify-center items-center h-full w-[75%] max-[768px]:w-[90%] max-[480px]:flex-col'>
					...
					>
						<div className='bg-textBlack bg-opacity-90 rounded-r-xl flex flex-col justify-center items-center w-full h-full border-acent border-t-2 border-b-2 border-r-2 max-[1024px]:h-[90%] max-[480px]:h-full max-[480px]:w-full'>
							<h2 className='text-white  font-bold'>INICIA SESION</h2>
              <div className='w-[50%] bg-acent h-[1px] mb-10'></div>
							...
							<input
								className='my-2 w-2/3 h-12 text-lg bg-white text-textBlack pl-2 font-bold placeholder-primary placeholder:font-bold max-[768px]:w-3/4 max-[480px]:text-base'
								type='email'
								{...register('email', { required: true })}
								placeholder='Correo:'
							/>
