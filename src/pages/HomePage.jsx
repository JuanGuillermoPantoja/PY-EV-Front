...
function HomePage() {
	return (
      ...
      max-[480px]:flex-col'
			>
				<div
					className='w-1/2 bg-[#FFEEB3] h-full flex items-center justify-center first-letter
         max-[480px]:h-1/6'
				>
					<img
						className='max-[600px]:w-4/5 max-[480px]:w-1/3'
						src={logoeventBrew}
						alt=''
					/>
				</div>
				<div
					className='w-1/2 bg-[#AC703E] h-full flex flex-col justify-around items-center
        max-[480px]:justify-evenly'
				>
					<h2 className='text-7xl  max-[768px]:text-6xl max-[600px]:text-5xl max-[480px]:text-4xl'>
						Bienvenidos
					</h2>
              ...
              max-[480px]:text-sm'
					...
					<p
						className='w-4/5 h-1/3 text-center text-2xl
          max-[1024px]:text-xl
          max-[768px]:text-lg
          max-[600px]:text-lg
          max-[480px]:text-sm'
